        ...
        {({ isSubmitting, values }) => (
          <Form>
              ...
              <>
                <TextFormField
                  ...
                  rightElement={
                    ...
                    >
                      {showPassword ? (
                        <Eye className="h-4 w-4 text-[#A5A5A5]" strokeWidth={1.5} />
                      ) : (
                        <svg
                          width="16"
                          height="13"
            ...
            <Button
              ...
              className="mx-auto !p-3 lg:!py-2 !px-4 !h-auto w-full hover:shadow-md transition-shadow -mt-2 !bg-[#0F58F9] !text-[#ffffff] !rounded-md"
            >
              {multiStep && step === 1
                ? "Create Account"
                : isJoin
            ...
            {!isSignup && shouldVerify && (
              <Link
                ...
                className="text-[15px] text-[#0F58F9] -mt-2 cursor-pointer text-center lg:text-left w-full text-link font-medium"
              >
                Forgot password?
              </Link>
            )}
