#!/usr/bin/env python3
"""
Простой CSS генератор для круговой диаграммы
"""

def generate_simple_css(segments, chart_id="pie-chart"):
    """
    Генерирует простой CSS для круговой диаграммы
...
def test_simple_generator():
    ...
    result = generate_simple_css(test_segments, "test-chart")
    
    print("=== ПРОСТОЙ CSS ГЕНЕРАТОР ===")
    print("\nHTML:")
    print(result["html"])
    print("\nCSS:")
    print(result["css"])
