#!/usr/bin/env python3
"""
Простой генератор круговой диаграммы - альтернативная версия
"""
...
def create_pie_chart(segments, size=320):
    """
    ...
    try:
        ...
        for segment in segments:
            ...
            if percentage > 0:
                ...
                # Рисуем сегмент
                draw_pie_segment(draw, center_x, center_y, outer_radius, 
...
def draw_pie_segment(draw, cx, cy, radius, start_angle, end_angle, color):
...
def test_easy_pie_chart():
    """Тестирует простой генератор"""
    print("=== ТЕСТ ПРОСТОГО ГЕНЕРАТОРА ===")
    ...
    if image_base64:
        ...
        try:
            ...
            image.save("easy_pie_chart.png")
            print("✅ Изображение сохранено в: easy_pie_chart.png")
        except Exception as e:
