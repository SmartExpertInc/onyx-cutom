#!/usr/bin/env python3
"""
Test script to validate PDF generation fixes for image positioning and transforms.
This script tests the enhanced PDF generation with proper image offset and element position handling.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('test_pdf_fixes.log'),
...
def create_test_image():
    ...
    draw.text((50, 100), "For PDF Testing", fill='black', font=font)
...
def create_test_slides():
    """Create test slides with various image positioning scenarios."""
    
    test_image_path = create_test_image()
    
    test_slides = [
        {
            "name": "bullet-points_with_offset",
            "slide_data": {
                "props": {
                    "title": "Test Slide with Image Offset",
                    "bullets": [
                        "First bullet point",
                        "Second bullet point", 
                        "Third bullet point"
                ...
                "metadata": {
                    "elementPositions": {
                        "draggable-test-slide-1-0": {"x": 100, "y": 50},
                        "draggable-test-slide-1-image": {"x": 200, "y": 100}
                    }
                },
        ...
        },
        {
            ...
            "slide_data": {
                ...
                "metadata": {
                    "elementPositions": {
                        "draggable-test-slide-2-0": {"x": 150, "y": 75}
                    }
                },
        ...
        },
        {
            ...
            "slide_data": {
                ...
                "metadata": {
                    "elementPositions": {
                        "draggable-test-slide-3-0": {"x": 50, "y": 25}
                    }
                },
        ...
        {
            "name": "bullet-points_with_scale",
            "slide_data": {
                "props": {
                    "title": "Test Slide with Image Scale",
                    "bullets": [
                        "Scaled image test",
                ...
                "metadata": {
                    "elementPositions": {
                        "draggable-test-slide-4-0": {"x": 75, "y": 40}
                    }
                },
                "templateId": "bullet-points",
                "slideNumber": 4
...
async def main():
    ...
    logger.info("Starting PDF generation fixes validation...")
