  ...
  ({ 
    ...
    const cardContent = (
      ...
      >
        ...
        <div className="absolute -top-20 -left-16 w-110 h-110 bg-blue-50/50 rounded-full border-indigo-100/80" />
        <div className="absolute -top-12 -left-8 w-80 h-80 bg-blue-100/30 rounded-full border-indigo-100/80" />
