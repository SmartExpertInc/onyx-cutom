              ...
              <div className="relative max-w-xs mx-auto">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button 
                      variant="outline" 
                      className="w-full p-2 text-sm border border-[var(--border-light)] rounded-lg bg-white text-[#434343] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent justify-between"
                    >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
                {[
                  ...
                  <div
                    ...
                    className={`p-6 text-center rounded-xl border-2 transition-all duration-200 cursor-pointer relative ${
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center">
                      <div className={`w-12 h-12 rounded-xl mb-3 flex items-center justify-center ${
                        surveyData.workRole === option.value ? 'bg-blue-500' : 'bg-blue-100'
                      }`}>
                        <span className={`${surveyData.workRole === option.value ? 'text-white' : 'text-blue-600'}`}>
                          {option.icon}
                        </span>
                      </div>
        ...
        {/* Navigation Buttons */}
          ...
          {surveyStep > 1 && (
            <Button
              onClick={handleBack}
              variant="outline"
              className="flex items-center px-6 py-3 border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-200"
            >
            ...
            {surveyStep === 4 && selectedCategory === 'work' ? (
              <Button
                ...
                disabled={!surveyData.industry}
                    className={`flex items-center px-8 py-4 bg-blue-600 text-white rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl ${
                  surveyData.industry 
                        ? 'hover:bg-blue-700' 
              ...
              <Button
                ...
                disabled={
                  ...
                  (surveyStep === 4 && !surveyData.industry)
                    ...
                    className="flex items-center px-8 py-4 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed"
              >
