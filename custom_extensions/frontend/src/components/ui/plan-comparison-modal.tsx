    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-[95vw] max-w-[95vw] rounded-2xl p-0 max-h-[90vh] bg-white/80 backdrop-blur-sm overflow-hidden" hideCloseIcon>
        ...
        <div className="overflow-y-auto max-h-[90vh]">
          ...
          {/* Plan Cards with Features Inside */}
                  ...
                  <div key={plan.id} className="relative">
                    ...
                    <div className={`${
                      ...
                      <div className="p-6 pb-4">
                          ...
                          {plan.hasSeats && (
                            <div className="flex items-center gap-0">
                              <button 
                                ...
                                className="w-7 h-7 border border-[#E0E0E0] rounded-l-md flex items-center justify-center hover:bg-gray-50"
                              >
                                <Minus className="w-4 h-4" />
                              </button>
                              <span className="px-3 py-1 bg-white border border-[#E0E0E0] text-[#4D4D4D] text-sm font-medium">{teamSeats} seats</span>
                              <button 
                                onClick={() => setTeamSeats(teamSeats + 1)}
                                className="w-7 h-7 border border-[#E0E0E0] rounded-r-md flex items-center justify-center hover:bg-gray-50"
                              >
                        ...
                        <p className="text-sm text-[#A5A5A5] mb-3">{plan.billing}</p>
                        ...
                        <div className="border-t border-gray-200 pt-4">
                          <div className="space-y-3">
                            {features.map((feature, idx) => (
                              <div key={idx} className="flex items-center justify-center py-2 border-b border-gray-100 last:border-b-0">
