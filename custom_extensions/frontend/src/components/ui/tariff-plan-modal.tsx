...
const TariffPlanModal: React.FC<TariffPlanModalProps> = ({ open, onOpenChange }) => {
  ...
  return (
    <>
      ...
      <DialogContent className="sm:max-w-[1280px] max-w-[1080px] w-[80vw] rounded-xl p-0 max-h-[90vh] min-w-[830px] bg-gradient-to-b from-white/90 to-white/70 backdrop-blur-md" hideCloseIcon>
        {/* Close Button */}
        <button
          onClick={() => onOpenChange(false)}
          className="absolute top-4 right-4 z-50 w-7 h-7 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50 transition-colors duration-200"
          aria-label="Close modal"
        >
          <X className="w-5 h-5 text-[#71717A]" />
        </button>
        
        <ScrollArea className="h-[90vh] max-h-[920px] w-full">
          <div className="h-[90%] min-h-[700px] max-h-[920px]">
              ...
              <div className="text-center mb-13">
                ...
                <div className="inline-flex items-center bg-white rounded-full p-1 border border-gray-200 mt-1">
                  <button
                    ...
                    className={`px-5 py-2 rounded-full text-xs font-public-sans font-normal transition-all duration-300 ${
                ...
                {plans.map((plan) => (
                      ...
                      >
                        {plan.popular && (
                          <div className="absolute -top-5 left-0 right-0 z-10">
                            <div className="bg-blue-600 text-white px-4 py-1 rounded-t-lg text-xs font-medium font-public-sans text-center flex items-center justify-center gap-2">
                    ...
                    <div className="p-5 pt-6">
                      ...
                      <div className="text-gray-900">
                        ...
                        {plan.price > 0 && (
                          <span className="text-[11px] font-public-sans text-[#0D001B] font-normal">
                            / {billingCycle === 'monthly' ? t('tariffPlan.month', 'month') : t('tariffPlan.year', 'year')}
                          </span>
                        )}
                      </div>
                    ...
                    <button
                      ...
                      <div className="space-y-4 mb-8 font-public-sans flex-grow">
                        <div className="flex items-center">
                          <Check className="w-4 h-4 text-blue-600 mr-3 font-medium flex-shrink-0" />
