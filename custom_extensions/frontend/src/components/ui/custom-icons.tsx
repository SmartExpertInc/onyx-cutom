...
<svg width={30} height={30} viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Clock face */}
    <g filter="url(#filter1_i_886_2462)">
    <circle cx="26.25" cy="26.25" r="12.25" fill="#1158C3" fill-opacity="0.7"/>
    <circle cx="26.25" cy="26.25" r="10.25" fill="#7EE5FF" fill-opacity="0.3"/>
    </g>
    {/* Clock center dot */}
    <g filter="url(#filter2_i_886_2462)">
    <circle cx="26.25" cy="26.25" r="1.75" fill="white" fill-opacity="0.9"/>
    </g>
    {/* Hour hand */}
    <g filter="url(#filter3_i_886_2462)">
    <rect x="25.375" y="18.6667" width="1.75" height="7.58333" rx="0.875" fill="white" fill-opacity="0.8"/>
    </g>
    {/* Minute hand */}
    <g filter="url(#filter4_i_886_2462)">
    <rect x="25.375" y="20" width="1.75" height="12.25" rx="0.975" fill="white" fill-opacity="0.8"/>
    </g>
  </svg> 
);

export { ClockIcon, TextIcon };