...
export const onyxConnectorConfigs: Record<string, ConnectorConfig> = {
  ...
  airtable: {
    ...
    values: [
      ...
      {
        type: "list",
        query: "Enter table IDs:",
        label: "Table IDs",
        name: "table_ids",
        description: "Specify 0 or more table IDs to index from. If none specified, will index all tables in the base.",
        optional: true,
      },
    ],
    advanced_values: [],
    ...
    values: [
      {
        ...
        label: "Folder Paths",
        name: "folder_paths",
        description: "Specify 0 or more folder paths to index from. If none specified, will index all accessible folders.",
        optional: true,
      },
      {
        type: "checkbox",
