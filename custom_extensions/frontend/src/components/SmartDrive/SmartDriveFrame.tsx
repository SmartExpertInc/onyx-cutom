  ...
  return (
    <div className={`bg-white rounded-lg border border-gray-200 overflow-hidden ${className}`}>
      ...
      <div className="relative" style={{ height: '600px' }}>
        <iframe
          key={iframeKey}
          src={typeof window !== 'undefined' ? `${window.location.protocol}//${window.location.host}/smartdrive/index.php/apps/files/files${onFilesSelected ? '?fileSelection=true&freshApp=true&autologin=1' : ''}` : '/smartdrive/index.php/apps/files/files'}
