            ...
            {isAuthorized ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center gap-6 overflow-hidden">
                <svg width="465" height="148" viewBox="0 0 465 148" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clipPath="url(#clip0_1918_79172)">
                    <rect opacity="0.7" x="240.408" y="138.45" width="23.0069" height="22.9934" rx="11.4967" stroke="#878787" strokeWidth="0.609959"/>
                    <rect opacity="0.7" x="224.664" y="122.715" width="54.496" height="54.4645" rx="27.2322" stroke="#878787" strokeWidth="0.609959"/>
                    <rect opacity="0.7" x="208.919" y="106.981" width="85.9851" height="85.9356" rx="42.9678" stroke="#878787" strokeWidth="0.609959"/>
                    <rect opacity="0.7" x="193.175" y="91.2464" width="117.474" height="117.407" rx="58.7034" stroke="#878787" strokeWidth="0.609959"/>
                    <rect opacity="0.7" x="177.43" y="75.5081" width="148.963" height="148.878" rx="74.4389" stroke="#878787" strokeWidth="0.609959"/>
                    <rect opacity="0.7" x="161.686" y="59.7737" width="180.452" height="180.349" rx="90.1745" stroke="#878787" strokeWidth="0.609959"/>
                    <rect opacity="0.7" x="145.942" y="44.0394" width="211.942" height="211.82" rx="105.91" stroke="#878787" strokeWidth="0.609959"/>
                  ...
                  <path opacity="0.7" d="M102 147H402" stroke="#D6DEFC" strokeLinecap="round"/>
                  <defs>
                ...
                {/* Text */}
                <p className="text-center text-sm" style={{ color: '#171718' }}>
                  Comments are only available for<br />workspace members
                </p>
                
                {/* Sign up button */}
                <button
                  className="flex items-center gap-2 px-4 py-2 rounded-md text-white text-sm cursor-pointer hover:opacity-90 transition-opacity"
