  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="w-36 flex items-center justify-between px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none transition-colors cursor-pointer"
            ...
            {languageOptions.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2 text-sm text-left transition-colors cursor-pointer rounded-md ${
