...
export const ConcentricPhishingRiseSlideTemplate_old: React.FC<ConcentricPhishingRiseSlideProps & { theme?: SlideTheme | string }> = ({
  slideId,
  title = 'Phishing rise',
...
export default ConcentricPhishingRiseSlideTemplate_old;