...
import { ImpactMetricsSlideTemplate } from './ImpactMetricsSlideTemplate';
...
export const SLIDE_TEMPLATE_REGISTRY: TemplateRegistry = {
  ...
  'company-tools-resources-slide': {
    ...
    description: 'Slide with 4 content blocks in 2x2 grid layout',
    category: 'content',
    icon: '🛠️',
    ...
    propSchema: {
      title: { type: 'text', label: 'Title', required: true, maxLength: 100 },
      companyName: { type: 'text', label: 'Company Name', maxLength: 50 },
      companyLogoPath: { type: 'image', label: 'Company Logo' },
      profileImagePath: { type: 'image', label: 'Profile Image' },
      profileImageAlt: { type: 'text', label: 'Profile Image Alt Text' },
      contentBlocks: { type: 'array', label: 'Content Blocks', required: true }
    }
  },
  ...
  'resources-slide': {
    id: 'resources-slide',
    name: 'Resources',
    description: 'Slide with dark olive background and resource list',
    category: 'content',
    icon: '📚',
    ...
    propSchema: {
      ...
      profileImagePath: { type: 'image', label: 'Profile Image' },
      profileImageAlt: { type: 'text', label: 'Profile Image Alt Text' },
      resources: { type: 'array', label: 'Resources List', required: true }
    }
  },

  'impact-metrics-slide': {
    id: 'impact-metrics-slide',
    name: 'Impact Metrics',
    description: 'Slide with metrics on left and profile image on right',
    category: 'content',
    icon: '📊',
    component: ImpactMetricsSlideTemplate,
    defaultProps: {
      companyName: 'Logo',
      companyLogoPath: '',
      profileImagePath: '',
    ...
    propSchema: {
      ...
      profileImagePath: { type: 'image', label: 'Profile Image' },
      profileImageAlt: { type: 'text', label: 'Profile Image Alt Text' },
      metrics: { type: 'array', label: 'Metrics List', required: true }
    }
  },
  ...
  'table-of-contents-slide': {
    ...
    description: 'Slide with navigation buttons and profile image',
    category: 'content',
    icon: '📋',
    ...
    propSchema: {
      ...
      profileImagePath: { type: 'image', label: 'Profile Image' },
      profileImageAlt: { type: 'text', label: 'Profile Image Alt Text' },
      navigationButtons: { type: 'array', label: 'Navigation Buttons', required: true }
    }
  },

  'online-safety-tips-slide': {
    id: 'online-safety-tips-slide',
    name: 'Online Safety Tips',
    description: 'Slide with 4 numbered tips and profile image',
    category: 'content',
    icon: '🔒',
    ...
    propSchema: {
      ...
      profileImagePath: { type: 'image', label: 'Profile Image' },
      profileImageAlt: { type: 'text', label: 'Profile Image Alt Text' },
      tips: { type: 'array', label: 'Tips List', required: true }
    }
  },
