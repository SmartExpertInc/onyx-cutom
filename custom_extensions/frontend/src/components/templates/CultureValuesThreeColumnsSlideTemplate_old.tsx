...
export const CultureValuesThreeColumnsSlideTemplate_old: React.FC<CultureValuesThreeColumnsProps & { theme?: SlideTheme | string }> = ({
  ...
  console.log('🔴 CultureValuesThreeColumnsSlideTemplate_old (OLD) rendered with avatarPath:', avatarPath);
...
export default CultureValuesThreeColumnsSlideTemplate_old;
