...
export const MarketingAgencyThankYouSlideTemplate_old: React.FC<MarketingAgencyThankYouSlideProps & {
...
export default MarketingAgencyThankYouSlideTemplate_old;