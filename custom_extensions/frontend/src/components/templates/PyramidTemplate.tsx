...
export const PyramidTemplate: React.FC<PyramidTemplateProps> = ({
  ...
  const PyramidSVG1 = () => {
    ...
    return React.createElement('svg', { width: "170", height: "60", viewBox: "66 0 68 60" },
  ...
  const PyramidSVG2 = () => {
    ...
    return React.createElement('svg', { width: "341", height: "60", viewBox: "33 60 134 60" },
  ...
  const PyramidSVG3 = () => {
    ...
    return React.createElement('svg', { width: "512", height: "60", viewBox: "0 120 200 60" },
