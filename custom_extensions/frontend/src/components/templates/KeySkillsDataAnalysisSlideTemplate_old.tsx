...
export const KeySkillsDataAnalysisSlideTemplate: React.FC<KeySkillsDataAnalysisProps & { theme?: SlideTheme | string }> = ({
  ...
  const slide: React.CSSProperties = { width:'100%', aspectRatio:'16/9', background:'#FFFFFF', color:'#26362C', fontFamily: currentTheme.fonts.titleFont, position:'relative', display:'grid', gridTemplateColumns:'39.5% 60.5%', gap:'0px', padding:'0px' };
  ...
  const text: React.CSSProperties = { fontSize:'36px', color:'#09090B', fontFamily: "'Lora', serif", opacity: 0.7 };
...
export default KeySkillsDataAnalysisSlideTemplate_old;
