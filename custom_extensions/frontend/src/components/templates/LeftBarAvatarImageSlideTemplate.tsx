...
export const LeftBarAvatarImageSlideTemplate: React.FC<LeftBarAvatarImageProps & { theme?: SlideTheme | string }> = ({
  ...
  const avatarWrap: React.CSSProperties = { position:'absolute', left:'118px', zIndex:'10', top:'265px', width:'230px', height:'230px', borderRadius:'50%', overflow:'hidden', background:'#F9FAFE' };
