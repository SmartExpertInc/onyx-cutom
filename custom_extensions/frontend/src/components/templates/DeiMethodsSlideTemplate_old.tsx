...
export const DeiMethodsSlideTemplate_old: React.FC<DeiMethodsProps & { theme?: SlideTheme | string }> = ({
  ...
  const card: React.CSSProperties = { position:'absolute', left:'44px', right:'44px', top:'44px', bottom:'44px', background: backgroundColor || '#FFFFFF', borderRadius:'24px', border:'1px solid #102412' };
