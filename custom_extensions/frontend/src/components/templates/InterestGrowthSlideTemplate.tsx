            ...
            <div style={{ minHeight: `${percentageMinHeight}px`, display: 'flex', alignItems: 'flex-end' }}>
              {isEditable && editingCard?.index === i && editingCard?.field === 'percentage' ? (
                <ImprovedInlineEditor
                  ...
                  onCancel={() => setEditingCard(null)}
                  style={{ fontSize: percentageFontSize, color: '#202022', fontFamily: 'Lora-Bold, serif', fontWeight: 'normal', lineHeight: 1 }}
                />
              ) : (
                <div style={{ fontSize: percentageFontSize, color: '#202022', fontFamily: 'Lora-Bold, serif', fontWeight: 'normal', lineHeight: 1 }} onClick={() => isEditable && setEditingCard({ index: i, field: 'percentage' })}>{c.percentage}</div>
              )}
            </div>
