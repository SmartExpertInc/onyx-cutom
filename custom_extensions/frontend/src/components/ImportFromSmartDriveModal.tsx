...
export const ImportFromSmartDriveModal: React.FC<ImportFromSmartDriveModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'smart-drive' | 'connectors' | 'my-products'>('smart-drive');
  ...
  const hasKnowledgeBaseSelection = useMemo(() => {
    return selectedFilePaths.length > 0 || selectedConnectorIds.length > 0 || selectedProducts.length > 0;
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          <SmartDriveConnectors 
            ...
            onProductSelectionChange={isKnowledgeBaseMode ? setSelectedProducts : undefined}
          />
        </div>
