    ...
    <div>
                ...
                <div className="p-3">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <MoreHorizontal size={16} className="text-gray-400 invisible group-hover:visible" />
                    </div>
                </div>
            </Link>
    </div>
        ...
        <div>
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors">
                        <Plus size={16} />
                        New from blank
                    ...
                    {filters.map(filter => {
                        ...
                        return (
                            <button 
                                ...
                                className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors ${activeFilter === filter ? 'bg-gray-200 text-gray-800' : 'text-gray-600 hover:bg-gray-100'}`}
                            >
                                <Icon size={16} />
                                {filter}
                            </button>
