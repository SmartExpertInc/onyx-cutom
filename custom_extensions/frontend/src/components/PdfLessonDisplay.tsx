  ...
  return (
    <div className="font-['Inter',_sans-serif] bg-white p-4 sm:p-6 md:p-8 shadow-lg rounded-md max-w-3xl mx-auto my-6">
      ...
      <div className="flex justify-center mt-6 mb-4">
        <PdfDownloadButton dataToDisplay={dataToDisplay} parentProjectName={parentProjectName} lessonNumber={lessonNumber} />
      </div>
...
// PDF Download and Preview Component
const PdfDownloadButton = ({ dataToDisplay, parentProjectName, lessonNumber }: { 
  dataToDisplay: PdfLessonData | null; 
  parentProjectName?: string; 
  lessonNumber?: number; 
}) => {
