...
interface CommentsForGeneratedVideoProps {
  isAuthorized?: boolean;
}

const CommentsForGeneratedVideo = ({
  isAuthorized = true,
}: CommentsForGeneratedVideoProps): React.JSX.Element => {
...
export default CommentsForGeneratedVideo;
