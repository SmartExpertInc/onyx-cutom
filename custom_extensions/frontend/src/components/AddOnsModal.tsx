  ...
  return (
    <Card className="border border-gray-200">
      <CardHeader>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <CardDescription className="mt-1 text-[#949CA8] font-light text-[10px]">{addOn.description}</CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent className="space-y-2">
        ...
        {!addOn.isEnterprise && (
          <div className="flex border border-[#E0E0E0] rounded-sm py-1 px-2 items-center gap-2">
            <Button
              ...
              className="h-8 w-8 bg-blue-500 text-[#0F58F9]"
            >
              -
            </Button>
            ...
            <Button
              ...
              size="icon"
              onClick={() => onQuantityChange(1)}
              className="h-8 w-8 bg-white bg-blue-500 text-[#0F58F9]"
            >
              +
            </Button>
          </div>
        ...
        <Button className={`w-full ${addOn.isEnterprise ? 'bg-[#0F58F9] text-white' : 'bg-[#CCDBFC] text-[#0F58F9]'} cursor-pointer rounded-full`} variant="download">
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-5xl max-h-[90vh] blur-md bg-white/95 overflow-hidden flex flex-col p-0 rounded-xl relative">
        ...
        <Tabs defaultValue="credits" className="flex-1 overflow-hidden flex flex-col">
          <TabsList className="ml-6 mt-6 w-fit rounded-full">
            <TabsTrigger 
              value="credits" 
              className="group flex flex-col items-center gap-2 bg-gray-100 text-[#8C8C94] data-[state=active]:text-[#719AF5]"
            >
              <div className="flex items-center gap-2">
                <Coins size={16} />
                <span>{t('addOns.credits', 'Credits')}</span>
              </div>
              <div className="border-b data-[state=active]:border-[#719AF5] w-full h-1 border-[#B5B5B9] rounded-full" />
            </TabsTrigger>
            <TabsTrigger 
              value="storage" 
              className="group flex flex-col items-center gap-2 bg-gray-100 text-[#8C8C94] data-[state=active]:text-[#719AF5]"
            >
              <div className="flex items-center gap-2">
                <HardDrive size={16} />
                <span>{t('addOns.driveStorage', 'Drive storage')}</span>
              </div>
              <div className="border-b data-[state=active]:border-[#719AF5] w-full h-1 border-[#B5B5B9] rounded-full" />
            </TabsTrigger>
            <TabsTrigger 
