      ...
      <div className="relative shadow-xl w-[600px] max-w-[95vw] flex flex-col z-10" style={{ borderRadius: '12px', background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.95) 0%, rgba(255, 255, 255, 0.85) 100%)' }}>
        ...
        <div className="px-6 pb-6">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="bg-white text-xs hover:text-gray-800 px-3 py-1.5 border rounded-md flex items-center gap-2 cursor-pointer"
            style={{ color: '#878787', borderColor: '#E0E0E0' }} onClick={() => {
                if (showReady) return;
              }}
              title={showReady ? 'Soon' : undefined}
              disabled={showReady}>
