        ...
        <div className="px-6 py-4">
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-2">
                ...
                <>
                  ...
                  <div className="relative" data-download-dropdown>
                    <button 
                      ...
                      style={{ color: '#171718', borderColor: '#171718', border: '1px solid', cursor: 'pointer' }}
                    >
                      Download
              ...
              {/* Copy link button */}
              <button className="text-white px-3 py-1.5 rounded-md transition-colors text-xs flex items-center gap-2" style={{ backgroundColor: '#0F58F9', cursor: 'pointer' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#0D4CD4'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#0F58F9'}>
                ...
                {isMoreOptionsOpen && (
                  <div className="absolute top-full right-0 mt-1 bg-white border border-gray-200 rounded-md shadow-lg z-50 w-40">
                    <div className="py-1">
                      ...
                      <button className="w-full text-left px-3 py-2 hover:bg-gray-100 transition-colors text-xs flex items-center gap-2 text-gray-700" style={{ cursor: 'pointer' }}>
