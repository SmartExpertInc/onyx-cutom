    ...
    <div className="bg-white rounded-lg border border-gray-200">
      ...
      <div className="bg-gray-100 px-4 py-3 rounded-t-lg flex items-center justify-between h-16">
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* Trashcan button */}
          <button className="bg-white text-gray-600 hover:text-gray-800 hover:bg-gray-50 px-3 py-1 rounded-full text-sm font-medium border border-gray-300 hover:border-gray-400 transition-colors group relative" title="Remove media">
