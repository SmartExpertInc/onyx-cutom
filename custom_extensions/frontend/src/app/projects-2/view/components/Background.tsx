...
function Modal({ isOpen, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal content */}
      <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 z-10 h-[605px]">
        {/* Header */}
        ...
        <div className="flex h-full">
          ...
          <div className="w-64 bg-white p-4 flex flex-col">
            {/* My assets section */}
            <div className="mb-6">
              <h4 className="text-sm font-medium text-gray-500 mb-1 px-3">My assets</h4>
              <div className="flex items-center px-3 py-2 bg-gray-100 rounded-lg cursor-pointer transition-colors">
                {/* Folder icon */}
            ...
            <div className="mb-6 flex-1">
              <h4 className="text-sm font-medium text-gray-500 mb-1 px-3">Stock assets</h4>
