  ...
  return (
    <div className="h-full bg-white relative w-full border-0 overflow-y-auto">
      ...
      <div className={`relative z-10 flex flex-col items-start justify-start w-full px-2 ${selectedColor ? 'pt-20' : 'py-4'}`}>
        ...
        >
          <svg className="w-4 h-4 text-black mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
          <span className="font-medium text-black text-xs">Choose media</span>
        </div>
        ...
        <div className="w-full flex justify-center mb-6">
          <div className="flex items-center">
            ...
            <span className="px-4 text-gray-500 font-medium text-xs">OR</span>
            <div className="w-24 h-px bg-gray-300"></div>
          </div>
        </div>
