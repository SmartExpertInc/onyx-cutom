    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="px-6 pb-6">
          ...
          {/* Rating section */}
          <div className="flex items-center justify-center gap-3 bg-gray-50 border border-gray-200 rounded-lg px-4 py-2 mx-auto">
            <span className="text-gray-700 font-medium text-sm">How's the video and voice quality?</span>
            <div className="flex gap-1">
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  key={star}
                  className="bg-white border border-black rounded transition-colors hover:bg-gray-100"
                  onClick={() => console.log(`Rated ${star} stars`)}
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="black" stroke="black" strokeWidth="0.5">
