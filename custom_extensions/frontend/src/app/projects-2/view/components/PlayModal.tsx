            ...
            <div className="inline-flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2">
              ...
              <div className="flex gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="text-white hover:text-black transition-colors" style={{ filter: 'drop-shadow(0 0 0 black)' }}>
