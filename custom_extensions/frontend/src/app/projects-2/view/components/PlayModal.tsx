        ...
        <div className="px-6 pb-6">
          ...
          <div className="flex gap-6 mb-6">
            ...
            <div className="w-[300px] flex-shrink-0">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Create your first AI video</h3>
              
              {/* Buttons */}
              <div className="flex gap-3 mb-4">
                <button className="bg-black text-white px-4 py-3 rounded-xl hover:bg-gray-800 transition-colors font-medium">
                  Generate video
                </button>
                <button className="bg-white text-black border border-gray-300 px-4 py-3 rounded-xl hover:bg-gray-50 transition-colors font-medium flex items-center justify-center gap-2">
          ...
          {/* Rating section */}
          <div className="flex items-center justify-center gap-3 bg-gray-50 border border-gray-200 rounded-lg p-4">
            <span className="text-gray-700 font-medium text-sm">How's the video and voice quality?</span>
            <div className="flex gap-1">
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  key={star}
                  className="text-white hover:text-black transition-colors border border-gray-300 rounded"
