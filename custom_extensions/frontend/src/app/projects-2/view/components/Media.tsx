  ...
  const content = (
    <div className="flex h-full">
      ...
      <div className="w-64 bg-white p-4 flex flex-col">
        {/* My assets section */}
        <div className="mb-5">
          <h4 className="text-xs font-medium text-[#878787] mb-2">{t('panels.media.myAssets', 'My assets')}</h4>
          <div 
        ...
        <div className="mb-6 flex-1">
          <h4 className="text-xs font-medium text-[#878787] mb-2">{t('panels.media.stockAssets', 'Stock assets')}</h4>
          ...
          >
            ...
            <span className="text-sm text-black">{t('panels.media.music', 'Music')}</span>
            </div>
          ...
          >
            ...
            <span className="text-sm text-black">{t('panels.media.icon', 'Icon')}</span>
            </div>
