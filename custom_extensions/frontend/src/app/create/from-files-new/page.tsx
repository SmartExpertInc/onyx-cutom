      ...
      {isSmartDriveModalOpen && (
        ...
        >
          ...
          >
            ...
            {/* Tab content */}
            <div className="bg-white rounded-lg p-6 flex flex-col items-center" style={{ height: 'calc(90vh - 220px)' }}>
              <svg width="826" height="241" viewBox="0 0 826 241" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-8">
              ...
              {activeTab === 'smartdrive' && (
                <div>
                  {/* Smart Drive content will go here */}
                </div>
              )}
              {activeTab === 'connectors' && (
                <div>
                  {/* Connectors content will go here */}
                </div>
              )}
            </div>
