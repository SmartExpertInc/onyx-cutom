...
function GenerateProductPicker() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-3xl flex flex-col gap-3 items-center relative z-10">
        ...
        {((activeProduct === "Course") || 
          ...
          <div className="flex flex-col items-center gap-3 w-full max-w-3xl">
            ...
            <Textarea
              ...
              className="w-[95%] px-7 py-5 rounded-md bg-white shadow-lg text-lg text-black resize-none overflow-hidden max-h-[320px] border border-gray-100 focus:border-blue-300 focus:outline-none transition-colors placeholder-gray-400 relative z-10"
            ...
            <div className="w-full relative z-0">
              <div className="relative flex items-center justify-center mb-2">
                ...
                <button onClick={shuffleExamples} className="absolute left-1/2 ml-32 flex items-center gap-1.5 text-[#FBFAFF] hover:opacity-80 transition-opacity">
