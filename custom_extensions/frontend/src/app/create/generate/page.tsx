...
function GenerateProductPicker() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-3xl flex flex-col gap-4 items-center relative z-10">
        ...
        {((activeProduct === "Course") || 
          ...
          <div className="flex flex-col items-center gap-3 w-full max-w-3xl">
            ...
            <Textarea
              ...
              className="w-full px-7 py-5 rounded-md bg-white shadow-lg text-lg text-black resize-none overflow-hidden max-h-[320px] border border-gray-100 focus:border-blue-300 focus:outline-none transition-colors placeholder-gray-400 relative z-10"
            ...
            <div className="w-full relative z-0">
              <div className="relative flex items-center justify-center mb-2">
                <span className="bg-transparent px-4 text-lg font-semibold text-[#FBFAFF] text-center" style={{ letterSpacing: 0 }}>
                  {t('interface.generate.examplePrompts', 'Example prompts')}
                </span>
                <button onClick={shuffleExamples} className="absolute right-0 flex items-center gap-1.5 text-[#FBFAFF] hover:opacity-80 transition-opacity">
                ...
                {Array.from({ length: 6 }).map((_, index) =>
                  examples[index] ? (
                    ...
                    >
                      ...
                      <span className="absolute top-2 right-2 text-xl leading-none" style={{ color: "#71717A", fontWeight: 200 }}>+</span>
                    </button>
                  ) : (
