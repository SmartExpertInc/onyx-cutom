        ...
        {((activeProduct === "Course") || 
          ...
          <div className="flex flex-col items-center gap-3 w-full max-w-3xl">
            ...
            <div className="w-full relative z-0">
              <div className="flex items-center justify-center mb-2 relative gap-3">
                <span className="relative z-10 bg-transparent px-4 text-lg font-semibold text-[#FBFAFF] text-center" style={{ letterSpacing: 0 }}>
                  {t('interface.generate.examplePrompts', 'Example prompts')}
                </span>
                <button onClick={shuffleExamples} className="flex items-center gap-1.5 text-[#FBFAFF] hover:opacity-80 transition-opacity">
