...
const CreateFromFolderContent: React.FC<CreateFromFolderContentProps> = ({ folderId }) => {
  ...
  const { folders, files, isLoading, error, refreshFolders, getFolderDetails, folderDetails } = useDocumentsContext();
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        {folderFiles.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Upload some documents to get started with content creation.</p>
          </div>
        ) : (
          <>
