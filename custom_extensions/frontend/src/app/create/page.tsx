...
const ImportIcon: React.FC<{ size?: number }> = ({ size }) => (
  ...
  <foreignObject x="-7.33333" y="3.88835" width="74.6667" height="59.111"><div style={{backdropFilter:'blur(9.333333969116211px)',clipPath:'url(#bgblur_0_1339_30084_clip_path)',height:'100%',width:'100%'}}></div></foreignObject><g filter="url(#filter0_i_1339_30084)" data-figma-bg-blur-radius="9.33333">
...
const GenerateIcon: React.FC<{ size?: number }> = ({ size }) => (
  ...
  <foreignObject x="-5.9375" y="-5.9375" width="72.875" height="72.875"><div style={{backdropFilter:'blur(9.9375px)',clipPath:'url(#bgblur_0_1339_30065_clip_path)',height:'100%',width:'100%'}}></div></foreignObject><g filter="url(#filter0_i_1339_30065)" data-figma-bg-blur-radius="9.9375">
...
const TextIcon: React.FC<{ size?: number }> = ({ size }) => (
  ...
  <foreignObject x="9.83301" y="-4.75" width="55.417" height="70"><div style={{backdropFilter:'blur(8.75px)',clipPath:'url(#bgblur_0_1339_30050_clip_path)',height:'100%',width:'100%'}}></div></foreignObject><g filter="url(#filter0_i_1339_30050)" data-figma-bg-blur-radius="8.75">
