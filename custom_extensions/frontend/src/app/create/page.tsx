  ...
  return (
    <>
      ...
      <div className="w-full max-w-6xl flex flex-col gap-10 items-center">
        ...
        {/* Option cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10 w-full max-w-7xl backdrop-blur-md bg-white/20 border border-white/30 rounded-xl p-8 shadow-lg transition-all duration-200 hover:shadow-xl">
          <OptionCard
            Icon={TextIcon}
