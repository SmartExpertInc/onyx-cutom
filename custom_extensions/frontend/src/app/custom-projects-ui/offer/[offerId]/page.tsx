  ...
  useEffect(() => {
    const fetchOfferDetails = async () => {
      try {
        ...
        console.log(`Fetching offer details for ID: ${params.offerId}`);
        ...
        console.log(`Offer details response status: ${offerResponse.status}`);
        ...
        if (!offerResponse.ok) {
          ...
          console.error(`API Error: ${offerResponse.status} - ${errorText}`);
          throw new Error(`Failed to fetch offer details: ${offerResponse.status}`);
        }
