      ...
      {showClientNameModal && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center backdrop-blur-sm bg-black/30">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 relative border border-gray-100">
            ...
            <div className="mb-6">
              <h2 className="text-xl font-bold mb-2 text-gray-900">{t('interface.customizePDF', 'Customize PDF')}</h2>
              <p className="text-gray-600">{t('interface.enterClientName', 'Enter a client name to include in the PDF.')}</p>
            </div>
            ...
            <form onSubmit={(e) => {
              ...
              handleClientNameConfirm(clientName.trim() || null);
            }} className="space-y-4">
              <div>
                <label htmlFor="client-name" className="block text-sm font-semibold text-gray-700 mb-2">
                  {t('interface.clientName', 'Client Name')} ({t('interface.optional', 'Optional')})
                </label>
                <input
                  type="text"
                  id="client-name"
