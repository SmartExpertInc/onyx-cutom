...
export default function ProductViewNewPage() {
  ...
  const getSourcesFromProject = () => {
    ...
    return Array.from(sources).map(source => ({
      type: source === 'Course' || source === 'Create from scratch' ? 'file' : 'connector',
      name: source,
