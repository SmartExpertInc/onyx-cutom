  ...
  return (
    <header className="flex items-center justify-between p-4 px-8 border-b border-gray-200 bg-white sticky top-0 z-10">
      ...
      <button 
          ...
          className="flex items-center gap-2 bg-[#F2CCFA] hover:bg-[#EBD5F0]/90 text-xs font-bold text-[#8808A2] px-3 py-2 rounded-full transition-all duration-200 cursor-pointer"
        >
