  ...
  return (
    <aside className="w-64 bg-white p-4 flex flex-col fixed h-full border-r border-gray-200 text-sm">
      <div className="relative mb-4">
        <div className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 flex items-center justify-center shadow-sm">
          <svg height="543" viewBox="17.086 17.192 885.828 165.617" width="2500" xmlns="http://www.w3.org/2000/svg">
