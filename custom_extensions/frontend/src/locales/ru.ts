export const ru = {
  ...
  actions: {
    ...
    ready: "Готово",
    failed: "Ошибка",
    popupBlocked: "Всплывающее окно было заблокировано. Пожалуйста, разрешите всплывающие окна для этого сайта, чтобы просмотреть превью.",
    popupBlockedConfirm: "Всплывающее окно было заблокировано. Хотите открыть превью в этом окне вместо этого?",
  ...
  interface: {
    ...
    themePicker: {
      ...
      description: "Выберите тему для изменения визуального стиля вашей презентации. Изменения будут применены немедленно.",
      applying: "Применение...",
