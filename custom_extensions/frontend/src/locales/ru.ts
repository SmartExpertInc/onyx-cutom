export const ru = {
  ...
  interface: {
    ...
    imageSettings: {
      ...
      captionPlaceholder: "Добавьте подпись под изображением...",
      captionHelp: "Подписи появляются под изображением",
      maxWidth: "Максимальная ширина",
      controlsImageSize: "управляет размером изображения",
      maxWidthHelp: "Максимальная ширина, которую может занимать изображение",
      maxWidthPlaceholder: "например, 100%, 500px, 50vw",
      quickSizeControls: "Быстрое управление размером",
      smaller: "Меньше",
      larger: "Больше",
      resetToDefaultSize: "Сбросить до размера по умолчанию",
      ...
      large: "Большой",
      circular: "Круглый",
      layoutOptions: "Опции макета",
      layoutMode: "Режим макета",
      layoutModeHelp: "как изображение отображается с другим контентом",
      standalone: "Отдельно (полная ширина)",
      ...
      equal: "Равное (по 50% каждому)",
      imageLarger: "Изображение больше (60% изображение, 40% контент)",
      contentLarger: "Контент больше (40% изображение, 60% контент)",
      imageDominant: "Доминирующее изображение (70% изображение, 30% контент)",
      contentDominant: "Доминирующий контент (30% изображение, 70% контент)",
      spaceDistributionDescription: "Управляет тем, сколько горизонтального пространства занимают изображение и контент.",
