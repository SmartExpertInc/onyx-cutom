export const ru = {
  ...
  interface: {
    ...
    eventPosterForm: {
      ...
      validation: {
        invalidImage: "Пожалуйста, выберите корректный файл изображения.",
        tooLarge: "Размер изображения должен быть меньше 5 МБ."
      }
    },
    ...
    posterResults: {
      ...
      subtitle: "Ваш постер мероприятия успешно сгенерирован",
      loading: "Загрузка результатов постера..."
    },

    // Event Poster component strings
    poster: {
      clickToEdit: "Нажмите, чтобы редактировать",
      editHint: "Нажмите на любой текст на постере, чтобы отредактировать. Enter — сохранить, Escape — отменить.",
      ticketLabel: "Квиток",
      actions: {
        generate: "Сгенерировать и скачать постер",
        generating: "Генерация постера...",
        generateTitle: "Сгенерировать и скачать изображение постера",
        generatingTitle: "Выполняется генерация изображения постера..."
      },
      placeholders: {
        dayMonth: "ДД.ММ",
        year: "ГГГГ",
    ...
    posterExamples: {
      eventName: "Большая онлайн‑конференция",
      mainSpeaker: "Денис Довгополый",
      speakerDescription: "основатель QNICORN NEST (Люксембург) ...",
      date: "08.10.2025",
      topic: "Тренды и приоритеты рынка VC в 2025–2026 годах",
      additionalSpeakers: "И еще 4 звездных спикера: ...",
      ticketPrice: "150€",
      ticketType: "STANDART",
      freeAccessConditions: "бесплатно для членов business club"
    },
  },
};
