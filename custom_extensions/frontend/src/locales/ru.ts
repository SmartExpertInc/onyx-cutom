export const ru = {
  ...
  interface: {
    ...
    eventPosterForm: {
      ...
      generatingPoster: "Генерация Плаката...",
      generateAndDownloadPoster: "Создать и Скачать Плакат",
      posterGenerationInProgress: "Генерация изображения плаката в процессе...",
      generateAndDownloadPosterTooltip: "Создать и скачать изображение плаката",
      editInstructions: "Нажмите на любой текст в плакате, чтобы отредактировать его. Нажмите Enter для сохранения, Escape для отмены.",
