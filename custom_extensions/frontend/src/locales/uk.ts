export const uk = {
  ...
  interface: {
    ...
    imageSettings: {
      ...
      captionPlaceholder: "Додайте підпис під зображенням...",
      captionHelp: "Підписи з'являються під зображенням",
      maxWidth: "Максимальна ширина",
      controlsImageSize: "керує розміром зображення",
      maxWidthHelp: "Максимальна ширина, яку може займати зображення",
      maxWidthPlaceholder: "наприклад, 100%, 500px, 50vw",
      quickSizeControls: "Швидке керування розміром",
      smaller: "Менше",
      larger: "Більше",
      ...
      large: "Великий",
      circular: "Круглий",
      layoutOptions: "Опції макета",
      layoutMode: "Режим макета",
      layoutModeHelp: "як зображення відображається з іншим контентом",
      standalone: "Окремо (повна ширина)",
      ...
      partnerContentHelp: "контент для розміщення поруч із зображенням",
      ...
      partnerContentDescription: "Виберіть, який блок контенту має з'являтися поруч із цим зображенням.",
      spaceDistribution: "Розподіл простору",
      spaceDistributionHelp: "скільки місця отримує кожен елемент",
      equal: "Рівний (по 50% кожному)",
      imageLarger: "Зображення більше (60% зображення, 40% контент)",
      contentLarger: "Контент більше (40% зображення, 60% контент)",
      imageDominant: "Домінуюче зображення (70% зображення, 30% контент)",
      contentDominant: "Домінуючий контент (30% зображення, 70% контент)",
      spaceDistributionDescription: "Керує тим, скільки горизонтального простору займають зображення та контент.",
