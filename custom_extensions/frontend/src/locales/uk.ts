export const uk = {
  ...
  interface: {
    ...
    eventPosterForm: {
      ...
      generatingPoster: "Генерація Плаката...",
      generateAndDownloadPoster: "Створити і Завантажити Плакат",
      posterGenerationInProgress: "Генерація зображення плаката в процесі...",
      generateAndDownloadPosterTooltip: "Створити і завантажити зображення плаката",
      editInstructions: "Натисніть на будь-який текст у плакаті, щоб відредагувати його. Натисніть Enter для збереження, Escape для скасування.",
