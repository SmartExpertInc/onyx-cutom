export const uk = {
  ...
  actions: {
    ...
    ready: "Готово",
    failed: "Помилка",
    popupBlocked: "Спливаюче вікно було заблоковано. Будь ласка, дозвольте спливаючі вікна для цього сайту, щоб переглянути превью.",
    popupBlockedConfirm: "Спливаюче вікно було заблоковано. Хочете відкрити превью в цьому вікні замість цього?",
    processing: "Обробка",
