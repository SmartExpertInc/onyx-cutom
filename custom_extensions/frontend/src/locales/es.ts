export const es = {
  ...
  interface: {
    ...
    imageSettings: {
      ...
      caption: "Leyenda",
      optional: "opcional",
      captionPlaceholder: "Agrega una leyenda debajo de la imagen...",
      captionHelp: "Las leyendas aparecen debajo de la imagen",
      maxWidth: "Ancho máximo",
      controlsImageSize: "controla el tamaño de la imagen",
      maxWidthHelp: "Ancho máximo que puede ocupar la imagen",
      maxWidthPlaceholder: "ej. 100%, 500px, 50vw",
      quickSizeControls: "Controles de tamaño rápido",
      smaller: "Más pequeño",
      larger: "Más grande",
      ...
      standalone: "Independiente (ancho completo)",
